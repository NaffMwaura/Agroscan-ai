    ...
    <div className="min-h-full">
      ...
      <header className="pt-32 pb-20 bg-green-900 text-white shadow-2xl">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          {/* --- ADDED max-w-sm TO LIMIT BUTTON LENGTH --- */}
          <Link 
            to="/login" 
            className="bg-amber-500 text-green-900 font-bold py-3 px-8 rounded-full text-lg shadow-xl transform transition duration-300 hover:bg-amber-400 hover:scale-105 flex items-center justify-center mx-auto space-x-2 max-w-sm"
          >
